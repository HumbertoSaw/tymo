...
class SolidColorBackgroundSetting extends ConsumerStatefulWidget {
  const SolidColorBackgroundSetting({super.key});

  @override
  ConsumerState<SolidColorBackgroundSetting> createState() =>
      _SolidColorBackgroundSettingState();
}

class _SolidColorBackgroundSettingState
    extends ConsumerState<SolidColorBackgroundSetting>
  ...
  void initState() {
    super.initState();
    _currentColor = ref.read(backgroundColorProvider);
